...
| ID | Issue | § |
|---|---|---|
| ~~**P2-1**~~ | ~~No turbulence model (no AoA jitter, no scintillation)~~ **FIXED** — `degrade/turbulence.hpp`, opt-in `[atmosphere.turbulence]`; Kolmogorov AoA at f^(−11/3) (asserted, fitted −3.59) and log-normal scintillation. Design §14.0j | 8.2 |
